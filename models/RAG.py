...
class MusashinoAssistant_RAG:
    def __init__(self):
        ...
        self.vectors = np.load('vector_db/jp_vectors_RAG.npy')
        with open('vector_db/jp_metadata_RAG.json', 'r', encoding='utf-8') as f:
    ...
    def get_answer(self, user_query):
        ...
        1. 回答は簡潔かつ丁寧な日本語で行ってください。
        2. 回答の最後に、必ず引用した資料の「URL」を明記してください。
        3. 資料に答えがない場合は「該当する情報が見つかりませんでした」と回答してください。
        """
